"""
1stDibs Price Tracker - Bright Data Web Scraper API
----------------------------------------------------
Track prices, availability, and product data from 1stDibs.

Docs  : https://docs.brightdata.co.kr/scraping-automation/web-scraper-api/overview
Info  : https://brightdata.co.kr/products/insights/price-tracker/1stdibs
"""
...
# Set your Web Scraper ID after building your 1stDibs scraper:
# https://brightdata.co.kr/products/web-scraper/1stdibs
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your 1stDibs scraper at: https://brightdata.co.kr/products/web-scraper/1stdibs\n"
...
def track_prices(urls: list[str], **kwargs) -> list[dict]:
    """
    Collect price data for a list of 1stDibs product URLs.
...
def discover_by_keyword(keyword: str, limit: int = 50, **kwargs) -> list[dict]:
    """
    Discover 1stDibs products by keyword search.
...
def discover_by_category(category_url: str, limit: int = 100, **kwargs) -> list[dict]:
    """
    Discover all products from a 1stDibs category page.

    Example:
        results = discover_by_category("https://1stdibs.com/s?k=headphones", limit=200)
    """
...
if __name__ == "__main__":
    ...
    sample_urls = [
        "https://www.1stdibs.com/en/products/sample-product-123456",
        # Add more 1stDibs product URLs here
    ]
    results = track_prices(sample_urls)

    output_file = "1stdibs_prices.json"
    ...
    # cat_results = discover_by_category("https://1stdibs.com/category/sample", limit=50)
